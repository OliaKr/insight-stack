...
# # Save reports to Redis memory
# save_report_to_memory("memory:sales:2025-04-01", sales_text)
# save_report_to_memory("memory:support:2025-04-01", support_text)
# save_report_to_memory("memory:operations:2025-04-01", ops_text)

# # Retrieve similar past memories
# sales_memory = retrieve_similar_memories(
#     "memory:sales:2025-04-01", "sales performance", top_k=2)
# support_memory = retrieve_similar_memories(
#     "memory:support:2025-04-01", "customer issues", top_k=2)
# ops_memory = retrieve_similar_memories(
#     "memory:operations:2025-04-01", "operational delays", top_k=2)
...
=== Past Memory: ===
Sales: {'/n'.join(sales_memory)}
Support: {'/n'.join(support_memory)}
Operations: {'/n'.join(ops_memory)}
